...
$_COOKIE["pagina"]="paraConvalidar.php";
?>
...
<body>
	...
	<?php
			...
			echo '<div id="grilla">';
				...
				while($row = mysql_fetch_array($Res))
				{
				   ...
				   else
				   {
					...
					echo        '<td id="info">' . "<input type='image' onclick='window.open(\"info.php?id=" . $row['idReg'] .  "\",\"cubaPete\",\"toolbar=no,status=no,menubar=no,resizable=no,width=350,height=600\");' src='images/grilla/more2.png' style='width:20px;height:20px;'/><a></td>";
		...
		echo '<input type="button" style="width:150px;background-color: #E6EEEE;" value="Validar Marcados" onclick="procesar(1);"/>';
		echo '&nbsp;&nbsp;&nbsp;&nbsp;';
		echo '<input type="button" style="width:150px;background-color: #E6EEEE;" value="Descartar Marcados" onclick="procesar(2);"/>';
		echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
		echo '<img  id="cargando" src="images/grilla/cargando.gif" style="width:35px;height:35px;visibility:hidden;float:top;" />';	
