...
<body>
	...
	<div id="login-box">
			...
			<?php
				...
				<!-- <table >
					<tr> -->
						<div id="login-box-name" style="margin-top:20px;">Usuario:</div><div id="login-box-field" style="margin-top:20px;"><input name="nick" class="form-login" title="Usuario" value="" size="30" maxlength="2048" /></div>
