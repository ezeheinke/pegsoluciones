 ...
 * method onEvent. If such a method does not exist a
 * <code>Error</code> will be thrown.
 *
...
public class EventManager {
	...
	private void _doNotify(EventObserver object, String topic, Object someData) {
		...
		try {
			...
			throw new RuntimeException("An exception has ocurred when invoking a method");
		}
	}
